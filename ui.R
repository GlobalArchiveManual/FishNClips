      ...
      tabItems(
        ...
        tabItem(tabName = "acknowledgements",
                fluidRow(box(width = 8, status = "primary", height = 800, title = "Acknowledgments",
                             ...
                             "South-west corner footage is contributing to a baseline survey of deepwater fishes and habitats, helping Parks Australia manage this unique part of Australia's marine environment. This project is jointly funded by Parks Australia, the University of Western Australia and the Australian Government's National Environmental Science Program.",br(),br(),
